...
class _ModalOrderState extends State<ModalOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isFormComplete =
        _selectedService != null && selectedServices.isNotEmpty;
              ...
              child: ListView(
                ...
                children: [
                    ...
                    child: Column(
                      children: filteredServices.map<Widget>((service) {
                        return ServiceItem(
                            ...
                            price: service['price'],
                            onSelected: (bool isChecked, String name,
                                double price, int quantity) {
                              updateSelectedServices(isChecked, service['id'],
                                  name, price, quantity);
                            },
                            isCountable: true);
                      }).toList(),
                  ...
                  CustomBtn(
                    ...
                    onPressed: isFormComplete ? submitOrder : null,
                  ),
                ],
              ),
            ),
